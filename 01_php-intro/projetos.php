...
<head>
   ...
   <div style="max-width: 800px; margin: 40px auto; padding: 0 20px;">
    ...
    irei listar alguns que acho mais interessante e que gosto mais:</p>
    ...
    <p>Este site de porfólio foi o primeiro site feito na disciplina de Desenvolvimento Web II, utilizando HTML, para estuturar a página 
        e CSS para estilizar e deixar a página bonita.</p>
    ...
    <p>Projeto desenvolivdo como avaliação do último bimestre da disciplina de Desenvolvimento Web, 
        ...
        podendo listar, alterar, cadastrar e excluir receitas do banco de dados utilizando PHP, HTML e CSS.</p>
    <a href="index.php"
